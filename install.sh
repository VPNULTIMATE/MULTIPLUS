...
clear
# REPO    
    REPO="https://github.com/VPNULTIMATE/MULTIPLUS"
...
TIMES=30
    ...
    local TEXT="<b>✅ INSTALASI MULTIPLUS VPN SELESAI ✅</b>
...
wget https://raw.githubusercontent.com/VPNULTIMATE/MULTIPLUS/main/menu.zip
unzip menu.zip
chmod +x menu/*
